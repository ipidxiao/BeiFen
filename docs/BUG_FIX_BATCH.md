...
- **BUG-007**：`story_char` 改为剧情内人物卡：姓名、职业/经历、HP/MP/SAN、基础属性（STR/CON/POW/DEX/APP/EDU/SIZ/INT/LUCK）与「← 返回剧情」；**保留多角色切换条**（多名活跃调查员时点击切换），不含装备/技能摘要/小队管理 CTA；活跃索引按 roster 同步，预置快速开始角色可直接展示。
