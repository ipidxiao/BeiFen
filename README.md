...
> 下列统计由 `npm run stats:readme` 生成（2026-07-05）；`--write` 可写回 README。
...
| 测试 | 39 suites | VM smoke + ESM + deep_verify（`npm test`） |
