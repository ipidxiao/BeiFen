// GENERATED from js/data/campaigns/masks_london_antagonist_rules.mjs — do not edit; run: npm run build:js
// Antagonist AI engine — organization opposition logic (user YAML → JS)

const ANTAGONIST_AI_RULES = {
...
function buildAntagonistPromptBlock(antState) {
