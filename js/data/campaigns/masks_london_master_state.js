// GENERATED from js/data/campaigns/masks_london_master_state.mjs — do not edit; run: npm run build:js
// Campaign master state — London Soho underground altar crisis (user-provided archive)

const CAMPAIGN_MASTER_STATE = {
...
const LONDON_KP_TIME_DEFAULTS = {
    date: '1925-03-15',
    anchorTime: '03:20_AM'
};

/** Build TIME block from campaign anchor time (e.g. 03:20_AM). */
function buildLondonKpTime(anchorTime) {
