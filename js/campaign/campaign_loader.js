// GENERATED from js/campaign/campaign_loader.mjs — do not edit; run: npm run build:js
 ...
 * @returns {string}
 */
function buildCampaignContextSummary(gameState) {
 ...
 * @returns {boolean}
 */
function loadMasksLondonCampaign(gameState, opts) {
...
function unloadCampaign(gameState) {
    if (!gameState) return;
