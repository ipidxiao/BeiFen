// GENERATED from js/ai/network.mjs — do not edit; run: npm run build:js
// ===============================================
...
const MAX_TOOL_ARG_STRING_LENGTH = 2000;
const MAX_TOOL_ARG_ARRAY_ITEMS = 40;
/**
 ...
 */
const getAiRetryBackoffMs = (failedAttempt) => {
 ...
 */
const fetchAiCompletionWithRetry = async (url, options = {}, timeoutMs = AI_REQUEST_TIMEOUT_MS, maxAttempts = AI_REQUEST_MAX_ATTEMPTS, onRetry = null) => {
