// GENERATED from js/state/core.mjs — do not edit; run: npm run build:js
// ===============================================
 ...
 */
window.CoCStateCore = (function(Vue) {
    if (!Vue) return {};
    ...
    const gameState = reactive({
        ...
        londonKpState: null,
        selectedCharIndex: 0,
        ui: { toasts: [], confirmDialog: null, saveLoading: false, saveLoadingMessage: '', openStoryTab: null },
