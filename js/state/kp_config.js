// GENERATED from js/state/kp_config.mjs — do not edit; run: npm run build:js
/**
...
function saveKpPreference(moduleId, enabled) {
    try {
...
function applyKpPreferenceToGameState(gameState) {
