...
export const GENERATE_PAIRS = [
    ...
    ['js/state/selection.mjs', 'js/state/selection.js'],
    ...
    ['js/core/globals_registry.mjs', 'js/core/globals_registry.js'],
    ...
    ['js/components/combat_ui_helpers.mjs', 'js/components/combat_ui_helpers.js'],
    ['js/components/chat_format_helpers.mjs', 'js/components/chat_format_helpers.js'],
    ['js/components/icon_sprite.mjs', 'js/components/icon_sprite.js'],
